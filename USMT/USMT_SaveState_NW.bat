...
PSEXEC \\%OriginatingPC% -u bpluscorp\%AdminUser% -h c:\USMT\amd64\Scanstate.exe "c:\usmt\Mig_Store" /c /o /tel:OFF /i:c:\usmt\amd64\MigApp.xml /i:c:\usmt\amd64\MigDocs.xml /v:13 /localonly /l:c:\usmt\amd64\scan.log /progress:c:\usmt\amd64\scanprog.log /ue:*\* /ui:bpluscorp\%UserName%

REM Copy USMT File to Blue Drive
ECHO Copying USMT directory to Local Host...
XCOPY \\%OriginatingPC%\c$\USMT c:\%username%\USMT\ /T /E /Y /I /C /Z
COPY \\%OriginatingPC%\c$\USMT\Mig_Store\USMT\* c:\%username%\USMT\Mig_Store\USMT\ /Y /Z
